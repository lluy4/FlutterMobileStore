          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextField(
                ...
                labelText: 'Tên quảng cáo',
                onSave: (val) {},
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Nhập tên quảng cáo';
                  }
                  return null;
                },
              ),
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        title: Center(child: Text('Tạo quảng cáo'.toUpperCase(), style: TextStyle(color: primaryColor))),
