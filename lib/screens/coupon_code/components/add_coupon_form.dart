                    ...
                    child: Consumer<CouponCodeProvider>(
                      builder: (context, couponProvider, child) {
                        return CustomDropdown(
                          ...
                          hintText: couponProvider.selectedCategory?.name ?? 'Chọn danh mục',
                    ...
                    child: Consumer<CouponCodeProvider>(
                      builder: (context, couponProvider, child) {
                        return CustomDropdown(
                          ...
                          hintText: couponProvider.selectedSubCategory?.name ?? 'Chọn phân loại',
                    ...
                    child: Consumer<CouponCodeProvider>(
                      builder: (context, couponProvider, child) {
                        return CustomDropdown(
                          ...
                          hintText: couponProvider.selectedProduct?.name ?? 'Chọn sản phẩm',
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        title: Center(child: Text('Tạo mã'.toUpperCase(), style: TextStyle(color: primaryColor))),
